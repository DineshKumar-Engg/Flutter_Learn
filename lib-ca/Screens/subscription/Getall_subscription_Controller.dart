...
class Getall_subscription_Controller extends GetConnect{

  String?service,token;
  RxList<dynamic> getsubscriptiondata=<dynamic>[].obs;

  Future<dynamic> GetSubscripionApi(BuildContext context)async{
    ...
    final url=Uri.parse("$service/api/v1/getallsubscriptions");
