...
class GetProfileController extends GetConnect{

  String?service,token;
  RxList<dynamic> getprofiledata=<dynamic>[].obs;
  ...
  Future<dynamic> GetProfileApi(BuildContext context)async{
    ...
    final url=Uri.parse("$service/api/v1/getadmin");
    ...
    if(responce.statusCode==200){
      ...
      getprofiledata.assignAll([value]);
      return responce;
    }
    else{
      return responce;
