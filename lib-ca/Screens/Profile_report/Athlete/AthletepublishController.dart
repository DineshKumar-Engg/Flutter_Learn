...
class AthletepublishController extends GetConnect{

  String?service,token;
  RxList<dynamic> publishdata=<dynamic>[].obs;

  Future<dynamic> AthletepublishApi(BuildContext context,id,publishstatus)async{
    ...
    final url=Uri.parse("$service/api/v1/athleteispublish/$id");
    ...
    if(responce.statusCode==200){
      StackDialog.show("Successfully Updated", "Athlete Profile Status Updated", Icons.verified, Colors.green);
      final value=(data['data']);
      publishdata.assignAll(value);
      return responce;
    }
