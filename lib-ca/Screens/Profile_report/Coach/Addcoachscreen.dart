...
class _AddcoachscreenState extends State<Addcoachscreen> {
  ...
  final CoachRegistrationApi coachRegistrationApi=Get.find<CoachRegistrationApi>();
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: appbar_widget("Add Coach"),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){
                          if(firstnamecontroller.text.isEmpty){
                            ...
                            StackDialog.show("Required Field is Empty", "Select Age you Coach", Icons.info, Colors.red);
                          }
                            ...
                            coachRegistrationApi.coachregistrtionapi(context, firstnamecontroller.text, lastnamecontroller.text, emailcontroller.text, selectedcityid,
                                selectestateid, sportsidsvalue, biocontroller.text, mobilecontroller.text, websitecontroller.text,
                                sendagewecoach, selectedgender, lookinforcontroller.text,iglinkcontroller.text,xlinkcontroller.text);
                          }
