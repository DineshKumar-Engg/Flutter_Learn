...
class Favourite_coach_View extends StatefulWidget {
  Map<String,dynamic> data;
   Favourite_coach_View({super.key,required this.data});

  @override
  State<Favourite_coach_View> createState() => _Favourite_coach_ViewState();
}

class _Favourite_coach_ViewState extends State<Favourite_coach_View> {
                                    ...
                                    child: InkWell(
                                      child: Container(
                                        ...
                                        child:IconButton(onPressed: (){
                                          setState((){
                                            like?
                                            favourite_add_controller.Favourite_Api(context, widget.data['favorite']['id'], 3)
                                                :
